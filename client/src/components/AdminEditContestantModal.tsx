...
export default function AdminEditContestantModal({
  contestant,
  onSuccess,
}: Props) {
      ...
      <DialogContent className="bg-[#2a0a1a] border-[#d4af37] text-white max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-[#d4af37]">
            Edit Contestant: {contestant.fullName}
          </DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={e =>
                  setFormData(p => ({
                    ...p,
                    countySubLocation: e.target.value,
                  }))
                }
                className="bg-[#4a1a2a] border-[#d4af37] text-white"
                required
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(val: any) =>
                  setFormData(p => ({ ...p, paymentStatus: val }))
                }
              >
                <SelectTrigger className="bg-[#4a1a2a] border-[#d4af37] text-white">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={e =>
                setFormData(p => ({ ...p, talents: e.target.value }))
              }
              className="bg-[#4a1a2a] border-[#d4af37] text-white"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={e =>
                setFormData(p => ({ ...p, socialMediaHandles: e.target.value }))
              }
              className="bg-[#4a1a2a] border-[#d4af37] text-white"
